						...
						<div class="topbar-menu right-menu" style="margin-right: 5px">
							<ul>
								<li class="menu-item lang-menu menu-item-has-children parent">
									<span title="Việt Nam" ><span class="img label-before" width="20px" height="15px"><img src="../assets/images/flag_vietnam.png" alt="lang-vi" width="20px" height="15px"></span>Việt Nam</span>
								...
								<li class="menu-item menu-item-has-children parent" >
									...
									<ul class="submenu curency" >
										{{-- <li class="menu-item" >
											<a title="hồ sơ" href="me.html">Hồ sơ</a>
										</li> --}}
										@if(Auth::user()->id==1)
										<li class="menu-item" >
										...
										{{-- <li class="menu-item" >
											<a title="danh mục" href="{{route('category.list')}}">Danh mục</a>
										</li>
										<li class="menu-item" >
											<a title="sản phẩm" href="{{route('product.list')}}">Sản phẩm</a>
										</li>
										<li class="menu-item" >
										...
										@endif
										{{-- <li class="menu-item" >
											<a title="cài đặt" href="setting.html">Cài đặt</a>
										</li> --}}
										<li>
										<form action="{{route('logout')}}" method="post">
											@csrf
											<a title="Đăng xuất" href="{{route('logout')}}" onclick="event.preventDefault(); this.closest('form').submit();">Đăng xuất</a>
										</form>
										</li>
									</ul>
								</li>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="/404" class="link-term mercado-item-title">Giới thiệu</a>
								</li>
								<li class="menu-item">
								...
								<li class="menu-item">
									<a href="/order-details" class="link-term mercado-item-title">Thông tin đơn hàng</a>
								</li>
								<li class="menu-item">
									<a href="/404" class="link-term mercado-item-title">Liên hệ</a>
								</li>
					...
					<ul>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								<h4 class="fc-name">Miến phí giao hàng</h4>
								<p class="fc-desc">Cho đơn hàng trên $1000</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">An toàn online thanh toán</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Đội ngũ hỗ trợ 24/7</p>
							</div>
					...
					<div class="row">
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">Hà Nội - Việt Nam</p>
											</li>
											<li>
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							...
							<div class="wrap-footer-item footer-item-second">
								<h3 class="item-header">Đăng kí nhận thông tin</h3>
								<div class="item-content">
							...
							<div class="row">
									...
									<div class="item-content">
										<div class="wrap-vertical-nav">
											<ul>
												...
												<li class="menu-item"><a href="#" class="link-term">Danh sách yêu thích</a></li>
											</ul>
										</div>
									</div>
								</div>
								<div class="wrap-footer-item twin-item">
									...
									<div class="item-content">
										<div class="wrap-vertical-nav">
											<ul>
												<li class="menu-item"><a href="#" class="link-term">Liên hệ với chúng tôi</a></li>
												<li class="menu-item"><a href="#" class="link-term">Đổi trả</a></li>
												<li class="menu-item"><a href="#" class="link-term">Sơ đồ website</a></li>
												<li class="menu-item"><a href="#" class="link-term">Khuyến mại đặc biệt</a></li>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2021 Nghiệp Hunter Company. All rights reserved</p>
					</div>
					<div class="coppy-right-item item-right">
						<div class="wrap-nav horizontal-nav">
							<ul>
								...
								<li class="menu-item"><a href="terms-conditions.html" class="link-term">Điều khoản điều kiện</a></li>
								<li class="menu-item"><a href="return-policy.html" class="link-term">Chính sách hoàn trả</a></li>								
							</ul>
						</div>
					</div>
